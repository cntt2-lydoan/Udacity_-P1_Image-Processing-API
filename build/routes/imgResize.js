...
var IMGS_DIR = path_1.default.join(__dirname, '../../Asset/images');
var RESIZED_IMGS_DIR = path_1.default.join(__dirname, '../../Asset/resizeImg');
if (!fs_1.default.existsSync(RESIZED_IMGS_DIR)) {
    fs_1.default.mkdirSync(RESIZED_IMGS_DIR);
}
var imgResize = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_b) {
        switch (_b.label) {
            ...
            case 1:
                _b.trys.push([1, 5, , 6]);
                imagePath = path_1.default.join(IMGS_DIR, imageName);
                resizedImagePath = path_1.default.join(RESIZED_IMGS_DIR, "".concat(imageName, "_").concat(width, "x").concat(height, ".jpg"));
